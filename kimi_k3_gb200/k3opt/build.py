...
SOURCES = ["kda_decode6.cu", "moe_small.cu", "ar_attn_res.cu", "lamport_attn_res.cu", "k3mla.cu", "kda_split.cu", "l2pf.cu", "k3gemv.cu", "oproj_ar.cu", "moe8.cu", "k3samp.cu", "k3step.cu", "k3step_prep.cu", "tail2.cu", "moebody.cu", "moe_front.cu", "oproj_front.cu"]
